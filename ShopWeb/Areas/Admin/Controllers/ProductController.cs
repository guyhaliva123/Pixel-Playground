...
namespace ShopWeb.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        private readonly IUnitOfWork _unitOfWork; //making a local vb to use it in any method 
        ...
        public IActionResult Upsert(ProductVM productVM, IFormFile? file)
        {
            ...
            // If ModelState is not valid, reload the CategoryList and return the view with errors
